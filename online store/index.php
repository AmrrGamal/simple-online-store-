...
};/* if  not مسجل رجعه تاني صفحه الوجين   */
...
if(isset($_POST['add_to_cart'])){
   ...
   $product_name = $_POST['product_name'];       /*  التلات المتغيرات المخفين اللي اللي تحت product_name */
   $product_price = $_POST['product_price'];    /*  التلات المتغيرات المخفين اللي اللي تحت  product_price */
   $product_image = $_POST['product_image'];    /*  التلات المتغيرات المخفين اللي اللي تحت   product_image */
...
<div  class="user-profile">
   ...
   <p> المستخدم الحالي : <span><?php echo $fetch_user['name']; echo '<br>' ; echo $fetch_user['email']; ?></span> </p>
   <div class="flex">
...
<!--طريقه اخري كان ممكن تدي الزر ال اي دي بتاع المتج 
 وبعد كده تعمل فوق بناء علي هدا ال اي دي لتري انه موجود من قبل ام لا "select" -->
 
         <input type="" name="product_image" value="<?php echo $row['image']; ?>">
         <input type="" name="product_name" value="<?php echo $row['name']; ?>">
         <input type="" name="product_price" value="<?php echo $row['price']; ?>">
